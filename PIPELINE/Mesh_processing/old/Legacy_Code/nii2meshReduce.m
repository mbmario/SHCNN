function [newVertices, faces] = nii2mesh(nii, filename, threshold, reduce)
...
fv = isosurface(image, threshold); % struct with vertices [n x 3] and faces [n x 3]
p = reducepatch(fv, reduce);
vertices = p.vertices;
faces = p.faces;
