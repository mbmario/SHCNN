...
%     new_M(1:3,4) = min(XYZmm,[],2);
   ...
   %
%    new_dim = ceil(new_M(1:3,1:3) \ ( max(XYZmm,[],2)-new_M(1:3,4) )+1)';
%    new_dim = ceil(new_M(1:3,1:3) \  round(max(XYZmm,[],2))-new_M(1:3,4) )';
   new_dim = ceil(new_M(1:3,1:3) \  max(XYZmm,[],2)-new_M(1:3,4))';
