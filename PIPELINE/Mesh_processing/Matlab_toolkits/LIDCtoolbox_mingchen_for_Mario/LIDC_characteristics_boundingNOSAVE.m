function [bounding_box_annotator,characteristics_annotator, roi_annotator, nodule_names] = LIDC_characteristics_boundingNOSAVE(xml_path, filename, z_min, slice_thickness)
