...
int main ( int argc, char * argv[]) {
	...
	//std::cout << "test regression error: " << train_error2 << std::endl; 
	//std::cout << "Variable Importance \n" << varImp << std::endl;
	

	// tree stuff
/*	int treect = rtree->get_tree_count();
	std::cout << "tree count is  " << treect << std::endl;
	for (int i=0; i < treect; i++) {
		std::cout << rtree->get_tree(i) << std::endl;
	}
*/
}